            ...
            <div className="flex gap-8">
              ...
              <div className="input-animation flex-1 rounded-xl border-2 border-solid border-indigo-400">
                <input
                  ...
                  ref={usernameRef}
                />
                <label className="login-placeholder pointer-events-none absolute left-[22rem] top-[13.75rem] select-none">
                  Přihlašovací jméno
                </label>
                <span className="login-title pointer-events-none absolute left-80 select-none">
                  Přihlašovací jméno
                </span>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div className="input-animation flex-1 rounded-xl border-2 border-solid border-indigo-400">
                <input
                  ...
                  ref={passwordRef}
                />
                <label className="login-placeholder pointer-events-none absolute left-[22rem] top-[19.25rem] select-none">
                  Heslo
                </label>
                <span className="login-title pointer-events-none absolute left-80 select-none">
                  Heslo
